	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<div class="row">
						<h3 class="title1">Add Food:</h3>
						<div class="form-three widget-shadow">
							<form class="form-horizontal" action="FoodFormServlet">
																						
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Food Type</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" required name="foodType" value="${FoodTypeValue}"/>
